...
export default async function Home() {
  ...
  return (
    <Card variant="bordered" css={{ mw: "41rem", margin: "50px auto" }}>
      <Card.Body>
        <Text>
          ...
          journey, our group offers the perfect platform to connect with
          like-minded individuals who share your zeal for all things software
          development. By joining us, you&apos;ll have the incredible
          ...
          development. Embrace this exciting adventure and join Nola Devs today!
        </Text>
      </Card.Body>
    </Card>
  );
